 ...
 * Author: Joel Heck
 *
 * Stores 5x7-pixel ASCII font mappings for the SSD1306 OLED driver in program
 * memory.
 *
 * Adapted from an Adafruit font file.
 */
...
static const unsigned char icons[] PROGMEM = {
	0x00, 0x02, 0x05, 0x02, 0x00	// Degree symbol
};
